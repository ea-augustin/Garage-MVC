    ...
    <div class="primary-overlay text-white">
        <div class="container">
            <div class="col-lg-6 mt-5 pt-5">
                <h2>Edit Car <?php  echo($vehicle->getModel().' '.$vehicle->getBrand()); ?></h2>
                <form method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        <input type="text" class="form-control" id="brand" name="brand"
                               aria-describedby="brandHelp"
                               placeholder="Brand" value="<?php echo ($vehicle->getBrand()) ?>">
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="model" name="model"
                               aria-describedby="modelHelp"
                               placeholder="Model" value="<?php echo ($vehicle->getModel()) ?>">
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="fuelType" name="fueltype"
                               aria-describedby="fuelTypeHelp"
                               placeholder="FuelType" value="<?php echo ($vehicle->getFueltype()) ?>">
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="horsepower" name="horsepower"
                               aria-describedby="horsepowerHelp"
                               placeholder="Horsepower" value="<?php echo ($vehicle->getHorsepower()) ?>">
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="price" name="price"
                               aria-describedby="priceHelp"
                               placeholder="Price" value="<?php echo ($vehicle->getPrice()) ?>">
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="description" name="description"
                               aria-describedby="descriptionHelp"
                               placeholder="Description" value="<?php echo ($vehicle->getDescription()) ?>">
                    </div>
